...
public class BitHelper {
  ...
  public static int msb(long value, int boardSize) {
    return boardSize * boardSize - 1 - Long.numberOfLeadingZeros(value);
  }

  public static int lsb(long value) {
  ...
  public static long fromSquare(int square) {
    return 1L << square;
  }
